...
class SubmittalValidation(BaseModel):
    ...
    match_type: str
    anti_hallucination_prompt: Optional[str] = None

class DecisionLogic(BaseModel):
    arch_found_submittal_found: Optional[str] = None
    arch_found_submittal_not_found: Optional[str] = None
    arch_not_found_submittal_found: Optional[str] = None
    arch_not_found_submittal_not_found: Optional[str] = None
    truth_table: Optional[List[Dict[str, Any]]] = None
...
class RuleDefinition(BaseModel):
    ...
    exclusion_logic: Optional[Dict[str, str]] = None
